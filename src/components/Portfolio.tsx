    ...
    <ThemeProvider defaultTheme="dark">
      <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
          ...
          <div className="absolute top-1/4 -left-32 w-72 h-72 bg-gradient-primary opacity-5 rounded-full blur-3xl animate-float-slow transform-gpu" />
          ...
          {/* Morphing Element */}
          <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-gradient-to-br from-primary/10 to-accent-blue/10 rounded-full blur-3xl animate-morph transform-gpu" />

          {/* Gradient Mesh */}
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_25%_25%,hsl(var(--primary)/0.05)_0%,transparent_50%)] animate-breathe" />
            <div
