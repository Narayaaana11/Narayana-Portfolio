...
const skills: Skill[] = [
  // Programming Languages
  {
    ...
    level: "intermediate",
    description:
      "Modern ES6+, DOM manipulation, async programming, functional programming",
    icon: Code,
    iconUrl:
  ...
  },
  {
    ...
    category: "programming",
    level: "intermediate",
    description: "Data structures, algorithms, web frameworks, automation",
    icon: Code,
    iconUrl:
  ...
  // { name: "Java", category: "programming", level: "intermediate", description: "OOP principles, collections, multithreading, Spring Boot", icon: Code, projects: 8 },
  {
    ...
    level: "intermediate",
    description:
      "Semantic markup, accessibility, SEO optimization, modern standards",
    icon: Globe,
    iconUrl:
  ...
  },
  {
    ...
    level: "intermediate",
    description:
      "Modern layouts, animations, responsive design, CSS Grid/Flexbox",
    icon: Palette,
    iconUrl:
  ...
  },
  {
    ...
    category: "programming",
    level: "intermediate",
    description: "Database queries, optimization, design, stored procedures",
    icon: Database,
    iconUrl:
  ...
  // Frontend Technologies
  {
    ...
    category: "frontend",
    level: "intermediate",
    description: "Hooks, Context API, performance optimization, testing",
    icon: Layers,
    iconUrl:
  ...
  },
  {
    ...
    category: "backend",
    level: "intermediate",
    description: "Web framework, routing, middleware, error handling",
    icon: Server,
    iconUrl:
  ...
  // { name: "FastAPI", category: "backend", level: "intermediate", description: "Python web framework, async programming, OpenAPI", icon: Server, projects: 4 },
  {
    ...
    category: "backend",
    level: "intermediate",
    description: "NoSQL database, aggregation, indexing, optimization",
    icon: Database,
    iconUrl:
  ...
  },
  {
    ...
    category: "tools",
    level: "intermediate",
    description: "Repository management, CI/CD, project collaboration, Actions",
    icon: GitBranch,
    iconUrl:
  ...
  },
  {
    ...
    level: "intermediate",
    description:
      "Extensions, debugging, productivity optimization, customization",
    icon: Monitor,
    iconUrl:
  ...
  },
  {
    ...
    category: "tools",
    level: "intermediate",
    description: "Backend as a service, real-time databases, authentication",
    icon: Cloud,
    iconUrl:
  ...
  },
  {
    ...
    category: "tools",
    level: "intermediate",
    description: "Cloud services, authentication, real-time database",
    icon: Cloud,
    iconUrl:
  ...
  // { name: "AWS", category: "devops", level: "intermediate", description: "Cloud services, EC2, S3, Lambda, deployment", icon: Cloud, projects: 3 },
  {
    ...
    category: "devops",
    level: "intermediate",
    description: "Deployment, hosting, edge functions, analytics",
    icon: Cloud,
    iconUrl:
  ...
  },
  {
    ...
    category: "devops",
    level: "intermediate",
    description: "Static site hosting, forms, functions, CI/CD",
    icon: Cloud,
    iconUrl:
  ...
  // { name: "System Design", category: "core", level: "intermediate", description: "Scalable architecture, design patterns, microservices", icon: Server, projects: 6 },
  {
    ...
    level: "intermediate",
    description:
      "Object-oriented programming principles, SOLID, design patterns",
    icon: Code,
    projects: 15,
  },
  {
    ...
    category: "core",
    level: "intermediate",
    description: "Database management, normalization, indexing, optimization",
    icon: Database,
    projects: 12,
  },
  {
    ...
    category: "core",
    level: "intermediate",
    description: "Data structures and algorithms optimization, problem solving",
    icon: Brain,
    projects: 20,
  },
  {
    ...
    category: "core",
    level: "intermediate",
    description: "Process management, memory allocation, system calls",
    icon: Server,
    projects: 8,
  },
  {
    ...
    category: "core",
    level: "intermediate",
    description: "TCP/IP, HTTP, WebSocket, network protocols",
    icon: Globe,
    projects: 10,
  },
  ...
  // Soft Skills
  {
    ...
    level: "intermediate",
    description:
      "Analytical thinking, debugging, optimization, creative solutions",
    icon: Target,
    projects: 25,
  },
  {
    ...
    category: "soft",
    level: "intermediate",
    description: "Agile methodologies, code reviews, mentoring, leadership",
    icon: Users,
    projects: 20,
  },
  {
    ...
    category: "soft",
    level: "intermediate",
    description: "Technical documentation, presentations, client interaction",
    icon: Users,
    projects: 15,
  },
  {
    ...
    category: "soft",
    level: "intermediate",
    description: "Project planning, deadline management, prioritization",
    icon: Shield,
    projects: 18,
  },
  {
    ...
    category: "soft",
    level: "intermediate",
    description: "Self-improvement, technology trends, skill development",
    icon: TrendingUp,
    projects: 25,
  },
  {
    ...
    category: "soft",
    level: "intermediate",
    description: "Creative thinking, new technologies, process improvement",
    icon: Lightbulb,
    projects: 12,
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
          {filteredSkills.map((skill) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute inset-0 transition-transform duration-700 ${isFlipped ? "rotate-y-180" : ""}`}
                >
                  {/* Front */}
                  <div
                    className={`absolute inset-0 p-4 sm:p-6 flex flex-col justify-between ${isFlipped ? "opacity-0" : "opacity-100"} transition-opacity duration-300`}
                  >
                      ...
                      <div className="p-2 rounded-lg bg-gradient-to-r from-primary/10 to-primary-glow/10">
                        {skill.iconUrl ? (
                          <img
                            src={skill.iconUrl}
                            alt={`${skill.name} icon`}
                            className="h-5 w-5 sm:h-6 sm:w-6 object-cover rounded"
                          />
                        ) : (
                          <SkillIcon
                            className={`h-5 w-5 sm:h-6 sm:w-6 ${levelColors[skill.level]}`}
                          />
                        )}
                      </div>
                      <Badge
                        variant="outline"
                        className={`text-xs ${levelColors[skill.level]} border-current`}
                      >
                  ...
                  {/* Back */}
                  <div
                    className={`absolute inset-0 p-4 sm:p-6 flex flex-col justify-center ${isFlipped ? "opacity-100" : "opacity-0"} transition-opacity duration-300 bg-gradient-to-br from-card via-secondary to-card`}
                  >
                      ...
                      <div className="p-3 rounded-xl bg-gradient-to-r from-primary/10 to-primary-glow/10 mx-auto w-fit">
                        {skill.iconUrl ? (
                          <img
                            src={skill.iconUrl}
                            alt={`${skill.name} icon`}
                            className="h-6 w-6 sm:h-8 sm:w-8 object-cover rounded mx-auto"
                          />
                        ) : (
                          <SkillIcon
                            className={`h-6 w-6 sm:h-8 sm:w-8 ${levelColors[skill.level]} mx-auto`}
                          />
                        )}
                      </div>
        ...
        <div className="mt-16 sm:mt-20 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4 sm:gap-6">
          {Object.entries(categories).map(([key, category]) => {
            ...
            const expertCount = categorySkills.filter(
            ...
            return (
              <Card
                key={key}
                className="p-4 sm:p-6 glass border-0 shadow-card text-center hover:shadow-lg transition-all duration-300 transform hover:scale-105"
              >
                <div className="p-3 rounded-xl bg-gradient-to-r from-primary/10 to-primary-glow/10 mx-auto w-fit mb-3">
                  <Icon
                    className={`h-6 w-6 sm:h-8 sm:w-8 ${category.color} mx-auto`}
                  />
                </div>
